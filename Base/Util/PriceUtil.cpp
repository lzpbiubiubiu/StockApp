...
namespace Base
{
    ...
    double PriceUtil::Round(double data, int num/* = 0*/)
    {
        ...
        {
            LOG_ERROR(QString("PriceUtil::Round data is nan or finite, data: %1").arg(data));
            return data;
        }
        ...
        {
            LOG_ERROR(QString("PriceUtil::Round data is too large, data: %1").arg(QString(str_data.c_str())));
            return data;
        }
