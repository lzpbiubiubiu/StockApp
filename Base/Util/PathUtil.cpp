...
namespace Base
{
    ...
    {
        static QString dirPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/StockApp/Database/";
        return CreateDir(dirPath);
    }

    QString PathUtil::GetConfigCacheDir()
    {
        static QString dirPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/StockApp/ConfigCache/";
        return CreateDir(dirPath);
    }
    ...
    {
        static QString dirPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/StockApp/CrashDump/";
        return CreateDir(dirPath);
    }
...
//        QString dirPath = dir.path() + "/Logs/";
        static QString dirPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/StockApp/Logs/";
        return CreateDir(dirPath);
    }

    QString PathUtil::GetDataDir()
    {
        static QString dirPath = QStandardPaths::writableLocation(QStandardPaths::DocumentsLocation) + "/StockApp/";
        return CreateDir(dirPath);
    }
    ...
    QString PathUtil::GetTempStockDir()
    {
        QString tempDir = GetTempDir() + "StockApp/";
