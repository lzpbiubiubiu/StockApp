...
#include "Base/Database/Inl/QdOrmDaoTable.inl"
#include "Base/Database/Inl/QdOrmDaoInsert.inl"
#include "Base/Database/Inl/QdOrmDaoSave.inl"
#include "Base/Database/Inl/QdOrmDaoFetch.inl"
#include "Base/Database/Inl/QdOrmDaoDelete.inl"
#include "Base/Database/Inl/QdOrmDaoUpdate.inl"
#include "Base/Database/Inl/QdOrmDaoAggregate.inl"
namespace Orm
{
    template <class T>
    class QdOrmDaoTable;
