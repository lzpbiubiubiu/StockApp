...
#include "Base/Database/Orm/QdOrmWhere.h"
...
namespace Sql
{
    ...
    public:
        ...
        /** 查找（主键匹配） */
        bool Exist(QSharedPointer<T>& t, QString& error)
        {
            if(!m_database)
            {
        ...
        /** 保存（插入或更新） */
        bool Save(QSharedPointer<T>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 保存集合（插入或更新） */
        bool SaveList(QList<QSharedPointer<T>>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 插入 */
        bool Add(QSharedPointer<T>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 插入集合 */
        bool AddList(QList<QSharedPointer<T>>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 查询（主键匹配）*/
        bool FindById(QSharedPointer<T>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 查询（条件匹配）*/
        bool FindByQuery(QList<QSharedPointer<T>>& t, Orm::QdOrmWhere& query, QString& error)
        {
        ...
        /** 获取全部 */
        bool ListAll(QList<QSharedPointer<T>>& t, QString& error)
        {
            if(m_database == nullptr)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 统计数量（条件匹配） */
        bool CountByQuery(long long& size, const Orm::QdOrmWhere& query, const QString& column, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 统计全部 */
        bool CountAll(long long& size, const QString& column, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 求和（条件匹配） */
        bool SumByQuery(QVariant& sum, const Orm::QdOrmWhere& query, const QString& column, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 更新（主键匹配）*/
        bool UpdateById(QSharedPointer<T>& t, const QStringList& columns, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        bool UpdateByQuery(QSharedPointer<T>& t, const QStringList& columns,
            Orm::QdOrmWhere& query, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 更新集合（主键匹配） */
        bool UpdateList(QList<QSharedPointer<T>>& t, QString& error)
        {
            if(!m_database)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 主键删除*/
        bool DeleteById(QSharedPointer<T> t, QString& error)
        {
            if(m_database == nullptr)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 主键批量删除*/
        bool DeleteListById(QList<QSharedPointer<T>>& t, QString& error)
        {
            if(m_database == nullptr)
            {
                error = "database has not been specified, call SetDatabase()";
        ...
        /** 条件删除 */
        bool DeleteByQuery(const Orm::QdOrmWhere& query, QString& error)
        {
            if(m_database == nullptr)
            {
                error = "database has not been specified, call SetDatabase()";
