...
namespace Orm
{
    ...
    public:
        static inline QSqlError insert(T& t, QSqlDatabase* database)
        {
            typedef typename std::conditional<std::is_pointer<typename T::value_type>::value, QdOrmDaoInsertContainerPtr<T>, QdOrmDaoInsertContainerGeneric<T>>::type type_1;
            typedef typename std::conditional<is_smart_ptr<typename T::value_type>::value, QdOrmDaoInsertContainerPtr<T>, type_1>::type type_2;
