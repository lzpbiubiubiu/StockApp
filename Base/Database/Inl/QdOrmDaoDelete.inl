...
namespace Orm
{
    ...
    public:
        static inline QSqlError deleteById(T& t, QSqlDatabase* database)
        {
            typedef typename std::conditional<std::is_pointer<typename T::value_type>::value, QdOrmDaoDeleteContainerPtr<T>, QdOrmDaoDeleteContainerGeneric<T>>::type type_1;
            typedef typename std::conditional<is_smart_ptr<typename T::value_type> ::value, QdOrmDaoDeleteContainerPtr<T>, type_1> ::type type_2;
