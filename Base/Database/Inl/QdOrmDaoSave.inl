...
namespace Orm
{
    ...
    public:
        static inline QSqlError save(T& t, QSqlDatabase* database)
        {
            typedef typename std::conditional<std::is_pointer<typename T::value_type>::value, QdOrmDaoSaveContainerPtr<T>, QdOrmDaoSaveContainerGeneric<T>>::type type_1;
            typedef typename std::conditional<is_smart_ptr<typename T::value_type>::value, QdOrmDaoSaveContainerPtr<T>, type_1>::type type_2;
