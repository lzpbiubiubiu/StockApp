...
namespace Orm
{
    ...
    public:
        static inline QSqlError updateById(T& t, QSqlDatabase* database, const QStringList& columns)
        {
            typedef typename std::conditional <std::is_pointer <typename T::value_type>::value, QdOrmDaoUpdateContainerPtr<T>, QdOrmDaoUpdateContainerGeneric<T >> ::type type_1;
            typedef typename std::conditional<is_smart_ptr<typename T::value_type>::value, QdOrmDaoUpdateContainerPtr<T>, type_1>::type type_2;
